...
<template>
  <form action="Oferta" method="post" name="formulario1" v-csrf-token>
    ...
    <input
      ...
      id="datos_credito"
      name="datos_credito"
      v-bind:value="this.datos_credito"
    />
    <input type="hidden" name="_token" :value="csrf" />
    <form-wizard
      class="form-w"
      title="Datos Para Renovacion de Credito"
      subtitle=""
          ...
          <div class="row">
            <div class="col-auto mr-auto">
              ...
              <input
                ...
                required
                class="form-control"
                v-bind:value="this.datos_personales.cliente_id"
              />
              <label class="label-datosPersonales" for="apellido_paterno"
              ...
              <input
                ...
                required
                class="form-control"
                v-bind:value="this.datos_personales.apellido_paterno"
              />
              ...
              <input
                ...
                readonly="readonly"
                placeholder="rfc"
                v-bind:value="this.datos_personales.rfc"
              />
              <label class="label-datosPersonales" for="ingresos"
                >Ingresos:</label
              >
              <input
                name="ingresos"
            ...
            <div class="col-auto mr-auto">
              ...
              <input
                ...
                class="form-control"
                readonly="readonly"
                v-bind:value="this.datos_personales.no_dependientes"
              />
              ...
              <input
                ...
                class="form-control"
                readonly="readonly"
                v-bind:value="this.datos_personales.estado_civil"
              />
              <label class="label-datosPersonales" for="ultimo_grado_estudios"
                >Ultimo grado Estudios:</label
              >
              <input
            ...
            <div class="col-auto mr-auto">
              ...
              <input
                ...
                class="form-control"
                readonly="readonly"
                v-bind:value="this.datos_personales.nombre"
              />
              <label class="label-datosPersonales" for="apellido_materno"
              ...
              <input
                ...
                class="form-control"
                readonly="readonly"
                v-bind:value="this.datos_personales.apellido_materno"
              />
              <label class="label-datosPersonales" for="fecha_nacimiento"
              ...
              <input
                ...
                class="form-control"
                readonly="readonly"
                v-bind:value="this.datos_personales.fecha_nacimiento"
              />
              <label class="label-datosPersonales" for="egresos"
                >Egresos:</label
              >
              <input
                name="egresos"
                ...
                class="form-control"
                readonly="readonly"
                v-bind:value="this.datos_personales.egresos"
              />
            </div>
          </div>
        </div>
          ...
          <div class="row2">
            <div class="col-auto mr-auto">
              ...
              <input
                ...
                v-model="calle"
              />
              <label class="label-datosPersonales" for="no_exterior"
                ># Exterior</label
              >
              <input
                name="no_exterior"
                ...
                v-model="no_exterior"
              />
              <label class="label-datosPersonales" for="colonia"
                >Colonia:
              </label>
              <br />
            ...
            <div class="col-auto mr-auto">
              ...
              <input
                ...
                v-model="no_interior"
              />
              <label class="label-datosPersonales" for="municipio"
                >Municipio:</label
              >
              <input
                name="municipio"
    ...
    <input
      ...
      readonly="readonly"
      class="form-control"
      v-bind:value="this.datos_credito.monto"
    />
    ...
    <input
      ...
      required
      class="form-control"
      v-bind:value="this.datos_credito.plazo"
    />
    ...
    <input
      ...
      class="form-control"
      readonly="readonly"
      v-bind:value="this.datos_credito.pago_mensual"
    />
...
export default {
  ...
  methods: {
    ...
    onComplete(e) {
      ...
      if (
        this.estado == "CP debe ser 5 números" ||
        this.estado == "Not Found" ||
        this.municipio == "CP debe ser 5 números" ||
    ...
    onChange(event) {
      ...
      axios
        .post("/DatosRenovacion_cp", { cp: event.target.value, RFC: this.rfc })
        .then((result) => {
